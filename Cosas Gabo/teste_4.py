...
def entrenar_modelo(force=False):
    ...
    # ========= MATRIZ DE CORRELACIÓN EJERCICIO =========
...
def recomendar_por_grupo(
    ...
    # ====================================
    # ✅ AGRUPAR EN LOTES DE 5 POR MUSCULO
    # ====================================
    ...
    for muscle in mlb.classes_:
        ...
        # filtrar ejercicios que trabajen este músculo
...
if __name__ == "__main__":
    ...
    recomendaciones = recomendar_por_grupo(
    user_data,
    user_priorities,
    exercises_per_group=5
)
